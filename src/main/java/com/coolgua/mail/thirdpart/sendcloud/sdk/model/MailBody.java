...
public class MailBody {
  ...
  public MailBody(String from, String fromName, String replyTo, String subject){
    this.from = from;
  ...
  public String getXsmtpapiString() {
    return JSONObject.toJSONString(xsmtpapi).toString();
  }
  ...
  public String getHeadersString() {
    return JSONObject.toJSONString(headers).toString();
  }
   ...
   * 设置发件人
   *
   * @param from <p> 格式：support@ifaxin.com, 爱发信支持&lt;support@ifaxin.com&gt; </p>
   */
