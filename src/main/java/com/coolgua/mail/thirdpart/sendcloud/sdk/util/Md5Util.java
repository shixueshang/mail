package com.coolgua.mail.thirdpart.sendcloud.sdk.util;
...
public class Md5Util {
	 ...
	 * 生成MD5校验码
	 */
	public static String getVeryfyCode(String salt, Object... objects) throws FileNotFoundException, IOException
	{
		...
		for (Object o : objects)
		{
			...
			{
				String md5 = SecurityUtil.getFileMd5(((File) o).getAbsolutePath());
				sb.append(md5);
			}
			else
			{
